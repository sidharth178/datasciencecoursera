...
shinyUI(pageWithSidebar(
        ...
        sidebarPanel(
                ...
                br(),
                p(strong(em("Documentation:",a("Body Mass Index Classification for Adults",href="https://github.com/sidharth178/datasciencecoursera/blob/master/Developing%20Data%20Products/week%203/README.html")))),
                p(strong(em("Github repository:",a("Developing Data Products - Shiny Application and Reproducible Pitch",href="https://github.com/sidharth178/datasciencecoursera/tree/master/Developing%20Data%20Products/week%203"))))
        ),
        mainPanel(
                tabsetPanel(
